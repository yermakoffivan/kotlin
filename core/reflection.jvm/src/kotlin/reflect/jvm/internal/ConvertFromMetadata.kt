...
internal fun createUnboundProperty(property: KmProperty, container: KDeclarationContainerImpl): KotlinKProperty<*> {
    ...
    return when {
        !property.isVar -> when (receiverCount) {
            ...
            0 -> KotlinKProperty0(container, signature, boundReceiver, property, KCallableOverriddenStorage.EMPTY, rawBoundContextArguments = null)
            1 -> KotlinKProperty1<Any?, Any?>(container, signature, boundReceiver, property, KCallableOverriddenStorage.EMPTY, rawBoundContextArguments = null)
            ...
            0 -> KotlinKMutableProperty0(container, signature, boundReceiver, property, KCallableOverriddenStorage.EMPTY, rawBoundContextArguments = null)
            1 -> KotlinKMutableProperty1<Any?, Any?>(container, signature, boundReceiver, property, KCallableOverriddenStorage.EMPTY, rawBoundContextArguments = null)
...
internal fun createUnboundFunction(function: KmFunction, container: KDeclarationContainerImpl): KotlinKFunction {
    ...
    return KotlinKNamedFunction(container, signature.toString(), CallableReference.NO_RECEIVER, rawBoundContextArguments = null, function, KCallableOverriddenStorage.EMPTY)
}
