...
internal open class DescriptorKPropertyN<out V> : DescriptorKProperty<V> {
    ...
    override fun createBound(boundReceiver: Any?) = throw KotlinReflectionInternalError("Cannot bind KPropertyN: $this")

    override fun createUnbound() = throw KotlinReflectionInternalError("Cannot unbind KPropertyN: $this")
