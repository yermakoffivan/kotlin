        ...
        class Static(
            ...
            override fun call(args: Array<*>): Any? {
                ...
                val allArgs = when {
                    ...
                    !isReceiverBound -> arrayOf(args[0], *boundContextArguments.toTypedArray(), *args.dropFirst())
                    hasInstanceParameter -> arrayOf(boundReceiver, *boundContextArguments.toTypedArray(), *args)
                    else -> arrayOf(*boundContextArguments.toTypedArray(), boundReceiver, *args)
                }
