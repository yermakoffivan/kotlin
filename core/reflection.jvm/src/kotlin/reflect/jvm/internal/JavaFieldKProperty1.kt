...
internal open class JavaFieldKProperty1<T, out V>(
    ...
    override fun createUnbound() = throw KotlinReflectionInternalError("Cannot unbind KProperty1: $this")

    override fun createBound(boundReceiver: Any?) = JavaFieldKProperty0<V>(container, jField, boundReceiver, overriddenStorage)
...
internal open class JavaFieldKMutableProperty1<T, V>(
    ...
    override fun createBound(boundReceiver: Any?) = JavaFieldKMutableProperty0<V>(container, jField, boundReceiver, overriddenStorage)
