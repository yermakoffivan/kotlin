...
internal class KotlinKConstructor(
...
) : KotlinKFunction(container, signature, rawBoundReceiver, rawBoundContextArguments = null, KCallableOverriddenStorage.EMPTY) {
    ...
    override fun createBound(boundReceiver: Any?, boundContextArguments: List<Any?>?): ReflectKCallable<Any?> {
        require(boundContextArguments.isNullOrEmpty()) { "Constructors cannot have bound context arguments: $this" }
