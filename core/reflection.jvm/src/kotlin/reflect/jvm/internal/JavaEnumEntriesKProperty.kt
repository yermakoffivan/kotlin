...
internal class JavaEnumEntriesKProperty(
    ...
    override fun createBound(boundReceiver: Any?) = throw KotlinReflectionInternalError("Cannot bind JavaEnumEntriesKProperty: $this")

    override fun createUnbound() = throw KotlinReflectionInternalError("Cannot unbind JavaEnumEntriesKProperty: $this")
    ...
    private inner class Getter : ReflectKCallableImpl<EnumEntries<*>>(KCallableOverriddenStorage.EMPTY), KProperty0.Getter<EnumEntries<*>> {
        ...
        override fun createBound(boundReceiver: Any?) = error("Property accessors can only be bound by copying the corresponding property")

        override fun createUnbound(): ReflectKCallable<EnumEntries<*>> =
