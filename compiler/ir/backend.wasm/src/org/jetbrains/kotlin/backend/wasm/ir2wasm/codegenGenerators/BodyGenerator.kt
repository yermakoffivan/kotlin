...
class BodyGenerator(
    ...
    private fun generateSuspendFunToContref(
        ...
        val contType = typeCodegenContext.referenceSuspendFunctionContType(suspendFunctionInvoke, invokeArity + 2)
        val boundContType = typeCodegenContext.referenceBoundContType()
