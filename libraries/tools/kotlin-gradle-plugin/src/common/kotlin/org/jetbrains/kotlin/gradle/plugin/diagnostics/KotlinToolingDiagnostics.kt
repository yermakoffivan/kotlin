...
internal object KotlinToolingDiagnostics {
    ...
    internal object PluginLoadedInMultipleProjectsError : ToolingDiagnosticFactory(
        ...
        operator fun invoke(loadedInProjectsByVersion: Map<String, List<String>>) = build {
            title {
                ...
                .description {
                    "The Kotlin plugin was loaded in the following projects:" +
                            loadedInProjectsByVersion.toSortedMap().entries
                                .joinToString(prefix = "\n", separator = "\n", postfix = "\n") { (version, projects) ->
                                    projects.sorted().joinToString(limit = 4, prefix = "- ", postfix = " (version $version)") { "'$it'" }
                                } +
